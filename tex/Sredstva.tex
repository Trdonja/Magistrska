...
obravnavali kot vektorsko preslikavo $F\colon U\to\V$. Na ta način so vsi odvodi preslikave $F$
smiselno definirani. Za $x\in U$ je odvod $DF(x)$ linearna preslikava iz prostora $V$ v prostor $\V$.
Če bomo želeli poudariti, da gre za vektorsko preslikavo, jo bomo označili s krepkim simbolom,
npr.~$\vek{F}$ namesto $F$.
...
\begin{definicija}
	\begin{itemize}
		\item
		Za krivuljo ali ploskev v prostoru $\E$ bomo rekli, da je razreda $C^r$, $r\in\mathbb{N}$,
		če se da to krivuljo ali ploskev parametrizirati s preslikavo, ki je razreda $C^r$.
		\item
