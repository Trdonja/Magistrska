...
\[
	\sigma(\ten{F})=\sigma(\ten{Q}\ten{F}\ten{Q}^T),\qquad\forall\:\ten{Q}\in\mathscr{O}(\V)
...
\[
	\bsi(\ten{B})=\sigma(\ten{F})=\sigma(\ten{Q}\ten{F}\ten{Q}^T)=
	\bsi(\ten{Q}\ten{F}\ten{Q}^T(\ten{Q}\ten{F}\ten{Q}^T)^T)=\bsi(\ten{Q}\ten{B}\ten{Q}^T),
\]
